...
namespace WeyhdBot.Wechat.Extensions
{
    public static class SenparcSdkExtension
    {
        public static IServiceCollection AddSenparcServers(this IServiceCollection services, IConfiguration Configuration)
        {
            /*
        ...
        public static IApplicationBuilder RegisterWeChat(this IApplicationBuilder app, IHostingEnvironment env, IOptions<SenparcSetting> senparcSetting, IOptions<SenparcWeixinSetting> senparcWeixinSetting)
        {
            // 启动 CO2NET 全局注册，必须！
            ...
            #region 注册公众号或小程序（按需）
                ...
                .RegisterMpAccount(senparcWeixinSetting.Value, "【友浩达】公众号");// DPBMARK_END
